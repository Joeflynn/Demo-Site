...
import { type ColorAreaAria, useColorArea } from '@react-aria/color'
import { useFocusRing } from '@react-aria/focus'
import { type ColorAreaState, useColorAreaState } from '@react-stately/color'
...
const ColorArea: React.FC<ColorAreaProps> = (props) => {
  ...
  const { colorAreaProps, xInputProps, yInputProps, thumbProps }: ColorAreaAria = useColorArea(
  ...
  const gradientStyle: CSSProperties = {
    ...
    borderRadius: BORDER_RADIUS,
    border: `0.5px solid ${isDisabled ? 'rgb(142, 142, 142)' : 'rgba(142, 142, 142, 0.9)'}`,
    height: SIZE,
    width: SIZE,
  }
